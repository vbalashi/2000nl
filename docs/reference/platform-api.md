...
implemented by `db/migrations/102_body_group_prefix_fallback.sql` and covered by
the DB/RPC grouped-search regression in `apps/ui/tests/fsrs/fsrsRpc.test.ts`.
