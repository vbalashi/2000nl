...
- 2026-08-21: Issue #225 reused the authenticated recent-history RPC behind a new lazy secondary destination. It does not restore the sidebar, eager loading, details coupling, or sidebar preference; its narrow display projection lives in `apps/ui/lib/training/trainingHistoryService.ts`.
