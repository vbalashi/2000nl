          ...
          <div className="flex min-h-0 flex-1 flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900/70">
            <div ref={listScrollRef} className="min-h-0 flex-1 overflow-y-auto">
              ...
              <div className="block space-y-3 p-3 md:hidden">
                {/* Mobile list picker */}
                <div className="rounded-2xl border border-slate-200 bg-white/80 p-3 shadow-sm dark:border-slate-800 dark:bg-slate-900/70">
                  <div className="flex items-center justify-between rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-800 shadow-sm dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100">
                    <div className="min-w-0">
                      ...
                      <div className="truncate text-xs text-slate-500 dark:text-slate-400">
                        Huidige training: {activeTrainingListName}
                      </div>
                    </div>
                    <button
                      type="button"
