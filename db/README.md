...
- `db/migrations/001_*.sql` through the current numbered migration (`154` at
...
- `db/deploy-contract/ledger-v1.sql` creates the immutable deployment ledger
  ...
  covers migrations `123` through `154` after baseline `122`.
...
contract `2000nl-db-154`, required migration `154`, and the exact checksums for
