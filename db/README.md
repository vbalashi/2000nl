...
- `db/migrations/001_*.sql` through the current numbered migration (`141` at
...
- `db/deploy-contract/ledger-v1.sql` creates the immutable deployment ledger
  ...
  covers migrations `123` through `141` after baseline `122`.
...
contract `2000nl-db-141`, required migration `141`, and the exact checksums for
