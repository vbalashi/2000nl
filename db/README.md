...
- `db/migrations/001_*.sql` through the current numbered migration (`156` at
...
- `db/deploy-contract/ledger-v1.sql` creates the immutable deployment ledger
  ...
  covers migrations `123` through `156` after baseline `122`.
...
contract `2000nl-db-156`, required migration `156`, and the exact checksums for
