...
- `db/migrations/001_*.sql` through the current numbered migration (`140` at
...
- `db/deploy-contract/ledger-v1.sql` creates the immutable deployment ledger
  ...
  covers migrations `123` through `140` after baseline `122`.
...
contract `2000nl-db-140`, required migration `140`, and the exact checksums for
