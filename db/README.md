...
- `db/migrations/001_*.sql` through the current numbered migration (`139` at
...
- `db/deploy-contract/ledger-v1.sql` creates the immutable deployment ledger
  ...
  covers migrations `123` through `139` after baseline `122`.
...
contract `2000nl-db-139`, required migration `139`, and the exact checksums for
