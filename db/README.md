...
- `db/migrations/001_*.sql` through the current numbered migration (`145` at
...
- `db/deploy-contract/ledger-v1.sql` creates the immutable deployment ledger
  ...
  covers migrations `123` through `145` after baseline `122`.
...
contract `2000nl-db-145`, required migration `145`, and the exact checksums for
