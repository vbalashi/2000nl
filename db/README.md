...
- `db/migrations/001_*.sql` through the current numbered migration (`151` at
...
- `db/deploy-contract/ledger-v1.sql` creates the immutable deployment ledger
  ...
  covers migrations `123` through `151` after baseline `122`.
...
contract `2000nl-db-151`, required migration `151`, and the exact checksums for
