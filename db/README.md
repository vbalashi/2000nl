...
- `db/migrations/001_*.sql` through the current numbered migration (`155` at
...
- `db/deploy-contract/ledger-v1.sql` creates the immutable deployment ledger
  ...
  covers migrations `123` through `155` after baseline `122`.
...
contract `2000nl-db-155`, required migration `155`, and the exact checksums for
