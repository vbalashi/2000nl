...
- `db/migrations/001_*.sql` through the current numbered migration (`146` at
...
- `db/deploy-contract/ledger-v1.sql` creates the immutable deployment ledger
  ...
  covers migrations `123` through `146` after baseline `122`.
...
contract `2000nl-db-146`, required migration `146`, and the exact checksums for
