...
- `db/migrations/001_*.sql` through the current numbered migration (`143` at
...
- `db/deploy-contract/ledger-v1.sql` creates the immutable deployment ledger
  ...
  covers migrations `123` through `143` after baseline `122`.
...
contract `2000nl-db-143`, required migration `143`, and the exact checksums for
