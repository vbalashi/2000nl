...
- `db/migrations/001_*.sql` through the current numbered migration (`161` at
...
- `db/deploy-contract/ledger-v1.sql` creates the immutable deployment ledger
  ...
  covers migrations `123` through `161` after baseline `122`.
...
contract `2000nl-db-161`, required migration `161`, and the exact checksums for
