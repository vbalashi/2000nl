...
- `db/migrations/001_*.sql` through the current numbered migration (`150` at
...
- `db/deploy-contract/ledger-v1.sql` creates the immutable deployment ledger
  ...
  covers migrations `123` through `150` after baseline `122`.
...
contract `2000nl-db-150`, required migration `150`, and the exact checksums for
