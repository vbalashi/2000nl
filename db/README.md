...
- `db/migrations/001_*.sql` through the current numbered migration (`160` at
...
- `db/deploy-contract/ledger-v1.sql` creates the immutable deployment ledger
  ...
  covers migrations `123` through `160` after baseline `122`.
...
contract `2000nl-db-160`, required migration `160`, and the exact checksums for
