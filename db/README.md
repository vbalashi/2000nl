...
- `db/migrations/001_*.sql` through the current numbered migration (`138` at
...
- `db/deploy-contract/ledger-v1.sql` creates the immutable deployment ledger
  ...
  covers migrations `123` through `138` after baseline `122`.
...
contract `2000nl-db-138`, required migration `138`, and the exact checksums for
