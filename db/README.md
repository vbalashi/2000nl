...
- `db/migrations/001_*.sql` through the current numbered migration (`142` at
...
- `db/deploy-contract/ledger-v1.sql` creates the immutable deployment ledger
  ...
  covers migrations `123` through `142` after baseline `122`.
...
contract `2000nl-db-142`, required migration `142`, and the exact checksums for
