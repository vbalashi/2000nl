...
- `db/migrations/001_*.sql` through the current numbered migration (`148` at
...
- `db/deploy-contract/ledger-v1.sql` creates the immutable deployment ledger
  ...
  covers migrations `123` through `148` after baseline `122`.
...
contract `2000nl-db-148`, required migration `148`, and the exact checksums for
