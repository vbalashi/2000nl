-- Read recent training history through a single backend boundary.
-- This keeps event/status joins and dictionary visibility checks out of the client.
