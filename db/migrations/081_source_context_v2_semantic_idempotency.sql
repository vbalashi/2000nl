-- For source-context-v2, compute idempotency from normalized semantic fields
-- only. Legacy v1 requests keep the original raw-sourceContext MD5 behavior.
...
BEGIN
    ...
    IF p_source_context->>'contractVersion' = 'source-context-v2' THEN
