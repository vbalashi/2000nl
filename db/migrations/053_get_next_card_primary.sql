-- Make get_next_card the primary scheduler RPC backed by card-state storage.

DROP FUNCTION IF EXISTS get_next_card(uuid, text[], uuid[], uuid, text, text, text, text[]);
...
DROP FUNCTION IF EXISTS get_next_word(uuid, text, uuid[], uuid, text);
