-- Return dictionary/source metadata when fetching a single accessible entry.
...
BEGIN
    ...
    SELECT jsonb_build_object(
        ...
        'dictionary_slug', d.slug,
        'dictionary_kind', d.kind,
    ...
    WHERE w.id = p_entry_id
      AND (
         ...
         OR can_access_dictionary(v_user_id, w.dictionary_id, 'read')
      );
